...
class __TwigTemplate_fc35c0d6e885284cad4bccf993f8830583aab7e650e546ea1766df3186cf6bd9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"jumbotron mt-4\" style=\"background-image: url(";
        ...
        echo "\" class=\"btn btn-warning\"><i class=\"fas fa-pencil-alt\"></i></a></h1>
            ...
            <p>";
        // line 26
        echo twig_truncate_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["projet"]) || array_key_exists("projet", $context) ? $context["projet"] : (function () { throw new RuntimeError('Variable "projet" does not exist.', 26, $this->source); })()), "resume", [], "any", false, false, false, 26), 355, true);
